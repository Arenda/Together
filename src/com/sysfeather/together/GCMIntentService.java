...
import com.sysfeather.together.RegisterActivity;
...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    protected void onRegistered(Context context, String registrationId) {
        ...
        ServerUtil.register(context, registrationId);
    }
    ...
    protected void onMessage(Context context, Intent intent) {
        ...
        String message = intent.getExtras().getString(Config.EXTRA_MESSAGE);
    ...
    protected boolean onRecoverableError(Context context, String errorId) {
        ...
        CommonUtil.displayMessage(context, getString(R.string.gcm_recoverable_error,
                errorId));
